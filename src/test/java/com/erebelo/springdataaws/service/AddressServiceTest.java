...
import static com.erebelo.springdataaws.mock.AddressMock.ADDRESSES_QUERY_TEMPLATE;
...
class AddressServiceTest {
    ...
    void testTriggerAddressFeedWith2KRecordsSuccessful() {
        given(queryMapping.getQueryByName(anyString())).willReturn(ADDRESSES_QUERY_TEMPLATE);
        given(athenaService.fetchDataFromAthena(anyString())).willReturn(getResponsePair());
    ...
    void testS3UploadFailure() throws NoSuchMethodException {
        ...
        AddressContextDto context = AddressContextDto.builder().headerProcessed(true)
                ...
                .processedRecords(2).byteArrayOutputStream(new ByteArrayOutputStream()).build();
