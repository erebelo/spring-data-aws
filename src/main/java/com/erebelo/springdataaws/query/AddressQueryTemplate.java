    ...
    public static final String LEGACY_ADDRESSES_QUERY_TEMPLATE = """
                ...
                legacy_addresses_grouped AS (
                    SELECT
                        ...
                        MAX(CASE WHEN TRIM(address_type) = 'HOME' THEN TRIM(zipcode) END) AS home_zip_code,
                        -- address_type WORK
                        ...
                        MAX(CASE WHEN TRIM(address_type) = 'WORK' THEN TRIM(zipcode) END) AS work_zip_code,
                        -- address_type OTHER
                        ...
                        MAX(CASE WHEN TRIM(address_type) = 'OTHER' THEN TRIM(zipcode) END) AS other_zip_code
